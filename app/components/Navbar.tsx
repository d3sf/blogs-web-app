          ...
          <div ref={dropdownRef} className="relative">
            {status === "loading" ? null : session?.user ? (
              ...
              <div className="flex space-x-2">
                <Link href="/signup" className="bg-black text-white px-4 py-2 rounded-full hover:bg-gray-800">
                  Sign Up
                </Link>
            ...
            {isOpen && (
              <div className="absolute right-0 mt-2 w-40 bg-white shadow-lg rounded-md p-2">
                <button className="block w-full text-left px-4 py-2 hover:bg-gray-100" onClick={handleProfileClick}>
                  Profile
                </button>
